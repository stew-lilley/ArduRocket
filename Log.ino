...
static void Log_Write_Nav_Tuning()
{
	...
	DataFlash.WriteInt((int16_t)0);  //was wp_distance
	DataFlash.WriteInt((uint16_t)0);  //was target_bearing
	DataFlash.WriteInt((uint16_t)0);  //was nav_bearing
	DataFlash.WriteInt(0);  //was altitude_error
                            ...
                            int32_t log_Ground_Speed, int32_t log_Ground_Course, byte log_Fix, byte log_NumSats)
{
	...
	DataFlash.WriteInt(0);				// was sonar_alt This one is just temporary for testing out sonar in fixed wing
